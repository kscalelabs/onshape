...
class ObjModel:
    def __init__(self, points: NDArray, faces: NDArray) -> None:
        self.points = points
        self.faces = faces
        self.load_obj_file()
    ...
    def calculate_plane_equations(self) -> None:
        self.plane_equ_para = []
    ...
    def calculate_q_matrices(self) -> None:
        self.Q_matrices = []
